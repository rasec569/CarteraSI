...
namespace Cartera.Reportes
{
    public class ReportesPDF
    {
        ...
        public void Ingresos(DataTable report,string total, string numero, string fecha, string concepto)
        {
            //string nombre = "Historial de pagos";
                    ...
                    try
                    {
                        ...
                        for (int i = 0; i < 4; i++)
                        {
                            ...
                            else if (i == 1)
                            {
                                ...
                                texto.Add("REPORTE: " + concepto +" FECHA: "+ DateTime.Now.ToString());
                                document.Add(texto);
                                texto.RemoveAt(0);
        ...
        public void Programado(DataTable report, string total, string numero, string fecha, string concepto)
        {
            //string nombre = "Historial de pagos";
        ...
        public void Ventas(DataTable report, string total, string numero, string fecha, string concepto)
        {
            //string nombre = "Historial de pagos";
        ...
        public void Disolucion(DataTable report, string total, string numero, string fecha, string concepto)
        {
            //string nombre = "Historial de pagos";
        ...
        public void Pagados(DataTable report, string total, string numero, string concepto)
        {
            //string nombre = "Historial de pagos";
                ...
                if (sfd.ShowDialog() == DialogResult.OK)
                {
                    ...
                    try
                    {
                        ...
                        for (int i = 0; i < 4; i++)
                        {
                            ...
                            {
                                document.Add(TablasLetras(report, new float[] { 25f, 30f, 15f, 10f, 10f, 10f}, 100, 7));
                            }
                            else
                            {
                                document.Add(new Paragraph(" "));
        ...
        public void Seguimento(DataTable report, string Producto, string Tipo, string Propietario, string Contacto)
        {
            //string nombre = "Historial de pagos";
                    ...
                    try
                    {
                        ...
                        for (int i = 0; i < 4; i++)
                        {
                            ...
                            else if (i == 1)
                            {
                                ...
                                //    fecha = dtinfo.GetMonthName(Fechai.Month) + " " + Fechai.Day + " DE " + Fechai.Year + " (A) " + dtinfo.GetMonthName(Fechaf.Month) + " " + Fechaf.Day + " DE " + Fechaf.Year;
                                //}
                                texto.Add(Propietario+" "+ Contacto+" FECHA REPORTE: " + DateTime.Now.ToString());
                                document.Add(texto);
                                texto.RemoveAt(0);
                            ...
                            {
                                document.Add(TablasLetras(report, new float[] { 15f, 85f }, 100, 6));
                            }
                            else
                            {
                                document.Add(new Paragraph(" "));
        ...
        public void Amortizacion(DataTable report, string cliente, string nomproducto, string nomproyecto,string ValorNeto, string ValorIni, string ValorSaldo, string ValorCuotaSal, string CuotasSal, string ValorInteres, string ValorFin, string PagadoFecha,   string InteresFecha, string SaldoFecha, string DeudaFecha)
        {
            //string nombre = "Historial de pagos";
                ...
                if (sfd.ShowDialog() == DialogResult.OK)
                {
                    ...
                    try
                    {
                        ...
                        for (int i = 0; i < 4; i++)
                        {
                            ...
                            {
                                document.Add(TablasLetras(report, new float[] { 8f, 11f, 11f, 11f, 11f, 11f, 11f, 11f, 12f }, 100, 7));
                            }
                            else
                            {
                                document.Add(new Paragraph(" "));
