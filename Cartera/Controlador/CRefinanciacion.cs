...
namespace Cartera.Controlador
{
    ...
    {
        public int crearRefinanciacion(int Valor_Neto_Refi, int Interes_Mora, int Valor_Deuda, int Cuotas_Refi, int Valor_Cuota_Refi, int Valor_Interes_Refi, int Valor_Total_Refi, string Fecha_Refi, string User_log_Refi, int Fk_Financiacion)
        {
