...
namespace Cartera.Modelo
{
    class MProducto { 
        ...
        public static int crearProducto(string Nombre_Producto, string Numero_contrato,string Forma_Pago,int Valor_Total,string Fecha_Venta,string Observaciones,int Fk_Id_Proyecto,int Fk_Id_Tipo_Producto){
        string sql = "INSERT INTO Producto(Nombre_Producto, Numero_contrato, Forma_Pago, Valor_Producto, Fecha_Venta, Observaciones, Fk_Id_Proyecto, Fk_Id_Tipo_Producto) VALUES(@Nombre_Producto, @Numero_contrato, @Forma_Pago, @Valor_Producto, @Fecha_Venta, @Observaciones, @Fk_Id_Proyecto, @Fk_Id_Tipo_Producto)";
                            ...
                            cmd.Parameters.Add(new SQLiteParameter("@Valor_Producto", Valor_Total));                            
        ...
        public static int actualizarProducto(int id_Producto, string Nombre_Producto,int Numero_contrato,string Forma_Pago,int Valor_Total,string Fecha_Venta,string Observaciones,int Fk_Id_Proyecto,int Fk_Id_Tipo_Producto){
